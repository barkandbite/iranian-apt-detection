...
- **FIXED (v4.0.22)**: **P0** — two rules broke Suricata 7.0.3 ruleset load, killing the entire file: SID 2000030 (`dsize:>500000` exceeded u16 max) and SID 2000535 (redundant `nocase` on normalized `http.host` promoted to hard error under `fast_pattern`). Rules corrected; all 429 rules now load cleanly.
...
**Last Updated**: July 1, 2026 | **Version**: 4.0.22 | **Maintainer**: Bark&Bite Security Intelligence
