...
- **NEW (v4.0.24)**: **Schneider/Siemens PLC targeting** (CISA AA26-097A 2026-07-22 update) — advisory widened from Rockwell to Schneider Electric and Siemens PLCs. 3 Suricata rules (SID 2000562-2000564, all `priority:1`, OT-only): Schneider Modicon **UMAS** (Modbus FC 0x5A) external control, Siemens **S7comm external CPU STOP** (fills the internal-only gap in SID 2000161), Siemens **S7comm external program download** (FC 0x1a). Network-only ICS behavioral — enable on OT-adjacent segments only.
...
```bash
# Deploy consolidated rules (v4.0 — single file, 441 signatures)
...
- **Suricata Signatures**: 441 network signatures (1 consolidated rule file)
...
│   ├── iranian-apt-detection.rules  # Consolidated v4.0 (441 rules)
│   └── README.md
...
**Last Updated**: August 1, 2026 | **Version**: 4.0.24 | **Maintainer**: Bark&Bite Security Intelligence
