...
```bash
# Deploy consolidated rules (v4.0 — single file, 452 signatures)
...
- **Suricata Signatures**: 452 network signatures (1 consolidated rule file)
...
│   ├── iranian-apt-detection.rules  # Consolidated v4.0 (452 rules)
│   └── README.md
...
**Last Updated**: August 20, 2026 | **Version**: 4.0.25 | **Maintainer**: Bark&Bite Security Intelligence
